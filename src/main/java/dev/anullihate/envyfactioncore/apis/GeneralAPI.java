package dev.anullihate.envyfactioncore.apis;
...
public class GeneralAPI {
    ...
    public GeneralAPI(EnvyFactionCore core) {
        this.core = core;
    }
    ...
    public Scoreboard processPlayerScoreboard(Player player, String titleSequence) {
        ...
        for (String text : this.core.getConfig().getStringList("scoreboard.lines")) {
            ...
            scoreboardDisplay.addLine(EnvyFactionCore.placeholderAPI.translateString(txt, player), this.line++);
        }
    ...
    public String getFactionTag(Player p) {
        String factionTag = EnvyFactionCore.p.getPlayerFactionTag(p);
