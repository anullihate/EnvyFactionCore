package dev.anullihate.envyfactioncore.dataobjects.users;
...
public class UserProfile {
    ...
    public static UserProfile loadUserProfile(String playerName) {
        try {
            UserTable userTable = EnvyFactionCore.userDao.queryForId(playerName);
    ...
    public void saveUserProfile() {
        try {
            UserTable userTable = EnvyFactionCore.userDao.queryForId(this.playerName);
            ...
            EnvyFactionCore.userDao.createOrUpdate(userTable);
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    }
